...
*/
const year = "1999";
console.log("soma string", year + 1);
parseInt("1999", 1999);
console.log(year);
console.log("soma num", parseInt(year) + 1);
...
console.log("dogtask 3", hungryDog(10, 1));
